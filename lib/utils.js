...
exports.calculateItemPercentages =
  exports.getMinMax =
  exports.formatNumberToCommaString =
  exports.uniqueValuesForKey =
  ...
  exports.setZeroValueForMatchingObjects =
  exports.calculateSumOfKey =
  exports.calculateAndInjectPercentage =
...
function calculateAndInjectPercentage(arr, key) {
  try {
...
exports.calculateAndInjectPercentage = calculateAndInjectPercentage;
...
function setZeroValueForMatchingObjects(arr, key, values) {
  return arr.map((item) => {
...
exports.setZeroValueForMatchingObjects = setZeroValueForMatchingObjects;
...
function uniqueValuesForKey(data, key) {
...
function calculateItemPercentages(arr) {
...
exports.calculateItemPercentages = calculateItemPercentages;
