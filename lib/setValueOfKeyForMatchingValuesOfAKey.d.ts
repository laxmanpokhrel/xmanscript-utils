 ...
 */
export default function setValueOfKeyForMatchingValuesOfAKey(arr: Record<string, any>[], key: string, values: string[], updateKey: string, value: any): Record<string, any>[];
